...
`elm-client-gen-core` and `elm-client-gen-http` metadata, then render them
...
overrides.alias("BigDecimal", elm_client_gen_core::ElmTypeRepr::String);
...
use elm_client_gen_http::registered_endpoints;
...
```rust
use elm_client_gen_builder::BuildStrategy;
